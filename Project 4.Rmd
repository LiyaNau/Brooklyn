...
```{r echo=FALSE,fig.height=8}
ggplot(filter(sales, price.square.foot > 0), aes(neighborhood, price.square.foot)) + 
  geom_boxplot() + 
  coord_flip(ylim = c(1,2500)) 
  #coord_cartesian(ylim = c(1,2500),expand = FALSE )
